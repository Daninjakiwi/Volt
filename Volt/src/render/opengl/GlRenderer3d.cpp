...
namespace volt {
	GlRenderer3d::GlRenderer3d(float fov, float aspect_ratio, float near_plane, float far_plane) : Renderer3d(), m_vert_array(0), m_vert_buffer(0), m_elem_buffer(0),m_tex_irradiance(0), m_tex_prefilter(0), m_tex_brdf(0), m_shader(nullptr), m_projection() {
